...
void papich_protected::del_protected() //удаление элемента
{
	del();
}

void papich_protected::print_protected()// вывод очереди на экран
{
	print();
}

void papich_protected::clear_protected()// очищение очереди
{
	clear();
}

double papich_protected::task_protected()//подсчет среднего гармонического
{
...
void papich_protected::copy_protected(papich_protected &q1) // копирование очереди
{
