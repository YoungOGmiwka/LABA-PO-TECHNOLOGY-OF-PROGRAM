...
void papich_pablic::copy_public(papich_pablic & q1) // копирование очереди
{
...
void papich_pablic::marge_public(papich_pablic &q1, papich_pablic & q2) // слияние очередей
{
...
double papich_pablic::task_public() // подсчет среднего гармонического
{
